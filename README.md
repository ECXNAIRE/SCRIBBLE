...
- Ellipse (hold ```shift``` for a circle)
- Triangle (hold ```shift``` for an equilateral triangle)
- Diamond (hold ```shift``` for a rhombus)
- Text tool
...
- Stroke / Fill colors
- Stroke width
- Pressure sensitive-drawing (drawing tablet support)
- Rough / sketch-style strokes
- Multiple fill styles

It also supports handwriting to text depending on you operating system
...
![HTML5 Canvas](https://img.shields.io/badge/HTML5%20Canvas-FF6F00?style=for-the-badge&logo=html5&logoColor=white)
