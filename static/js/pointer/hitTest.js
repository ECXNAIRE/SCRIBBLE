...
export function getClickedShape(mouseX, mouseY) {
...
export function getClickedHandle(shape, mouseX, mouseY) {
    const padding = 8
...
export function getClickedLineHandle(shape, mouseX, mouseY) {
    const size = 10
